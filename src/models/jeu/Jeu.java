...
//			checkRadiusNodes(tour);
	...
	public void terminer()
	{
		...
		Fenetre_JeuSolo.ajouterTexteHTMLDansConsole("<font color='blue'>" 
				+ "Wave reached: " + indiceVagueCourante +"</font><br />");
	}
...
//				edj.etoileGagnee();
	...
	public void passerALaProchaineVague()
	{
		...
		Fenetre_JeuSolo.ajouterTexteHTMLDansConsole("<font color='green'>" 
				+ "The " + indiceVagueCourante + extension 
				+ " wave has begun!" +"</font><br />");
		++indiceVagueCourante;
	}
