 ...
 * @since jdk1.6.0_16
 */
public class Noued extends Point
{
	 ...
	 */
	public boolean equals(Noued noeud)
	{
		/*
		 * Test du paramètre.
		 */
	 ...
	 */
	public static int[] coordonnee(Noued noeud, int deltaX, int deltaY)
	{
		/*
		 * Test du paramètre
		 */
